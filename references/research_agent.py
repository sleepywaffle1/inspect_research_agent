...
model = init_chat_model(model="openai/gpt-4.1-mini", model_provider="openrouter")
model_with_tools = model.bind_tools(tools)
# summarization_model = init_chat_model(model="openai:gpt-4.1-mini")
summarization_model = init_chat_model(model="openai/gpt-4.1-mini", model_provider="openrouter")
...
compress_model = init_chat_model(model="openai/gpt-4.1-mini", model_provider="openrouter", max_tokens=32000)
